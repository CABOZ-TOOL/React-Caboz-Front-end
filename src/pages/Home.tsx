...
const Home = () => {
  ...
  const getCollections = (limit: number) => {
    axios.get(`https://api-devnet.magiceden.dev/v2/collections?offset=0&limit=${limit}`)
      .then(res => {
        if (res.status === 200) {
      ...
      <>
        ...
        <div className="App">
          ...
          <main className="container">
            ...
            {/* <!-- Active Collections --> */}
            <Collections title='Active Collections' collections={collections} />
            {/* <!-- Trending Collections --> */}
            <Collections title='Trending Collections' collections={collections} />
          </main>
          {/* <!-- Footer --> */}
          <footer>
